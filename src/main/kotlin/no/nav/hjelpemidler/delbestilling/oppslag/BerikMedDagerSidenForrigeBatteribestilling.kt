...
class BerikMedDagerSidenForrigeBatteribestilling(
    ...
    fun berik(hjelpemiddel: Hjelpemiddel, serienr: String): Hjelpemiddel {
    ...
    private fun beregnAntallDagerSidenSisteBatteribestilling(hmsnr: String, serienr: String): Int? {
        return delbestillingRepository
