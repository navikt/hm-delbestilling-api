...
class FakeDelbestillingRepository : DelbestillingRepository {
    ...
    fun overstyrSak(saksnummer: Long, block: (DelbestillingSak) -> DelbestillingSak) {
        sakStore[saksnummer] = block(sakStore[saksnummer] ?: error("Sak $saksnummer finnes ikke"))
    }

    fun lagreDelbestilling(delbestilling: Delbestilling): Long {
        return lagreDelbestilling(
    ...
    override fun lagreDelbestilling(
        ...
        val saksnummer = saksnummerCounter.incrementAndGet()
